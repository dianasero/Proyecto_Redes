...
public class ServidorEco {
    ...
    private void darAltaContacto(String usuario, String contacto) throws FileNotFoundException, IOException{
    
        RandomAccessFile archivo = new RandomAccessFile("bd.txt", "rw");
        String auxiliar, in[], cargaArchivo = "";
        long posicion;
        
        if(buscar(contacto) != null || buscar(usuario)!= null){
    ...
    public String buscar(String nombreBuscar)throws IOException {
...
class GestorPeticion extends Thread {
    ...
    private ControladorLogico controladorLogico; 
    private int opcion;
